...
<div style="clear:both">Страница, к которой вы обратились, не существует на нашем сайте. Давайте попробуем начать ваш
    поиск сначала, вернувшись на <a href="/">главную страницу</a>, ведь как говорил классик:
</div>
<q><?php echo $a[0]; ?>
