...
class CommentYii extends DaActiveRecord
{
    ...
    const STATUS_HIDDEN_BANNED = 4; //@todo
...
//    public $captchaAction;
    ...
    */
     ...
     * @return array
     */
    private static function getFoulsList(){
        return array("гомосек", "хуй", "хуила", "пизда", "пиздеть", "пиздуй", "пиздец", "еблан", "ебанат", "ебать",
            "хуярить", "пидрила", "пидар", "пидор", "пидорас", "пидарас", "пидараст", "жопа", "жополиз", "гондон", "гандон", "говно",
            "гавно", "говнецо", "бляд", "блят", "бля", "охуе", "охереть", "чмо", "срать", "срач", "мудак", "ссать", "срать", "отсос", "обосос",
            "отсосать", "хуесос", "хуесосить", "говнюк", "педик", "херачить", "хуячить", "блядва", "ебанько", "дебил", "какашка", "гомик",
            "ублюдок", "дерьмо", "сука", "сучка", "суки", "ебало", "пиздобол", "пиздабол",
            "ментяра", "ахуе", "ахуеть", "никуя", "писец", "заепали", "заипали"
        );
    }
