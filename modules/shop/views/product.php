...
<div class="b-emarket-product">
    <div class="details">
        <?php if ($preview != null): ?>
            <a href="<?php echo $product->mainPhoto->getUrl(); ?>" class="to_zoom">
                <img class="image" src="<?php echo $preview->getUrl(); ?>"
                     alt="<?php echo CHtml::encode($product->name); ?>" title="">
            </a>
        <?php endif; ?>
        <div class="info-bar">
            <?php /* ?>
...
<? */ ?>
            <div class="item">
                ...
                <p><?php $this->widget('ygin.widgets.likeAndShare.LikeAndShareWidget', array(
                        "title" => $product->name,
                    )); ?></p>
            </div>
        </div>
    ...
    <div class="description">
        ...
        $tabs = array(
            array(
                'caption' => 'Скриншоты',
                'content' => trim($this->widget('PhotogalleryWidget', array(
                    "model" => $product,
                ), true)),
            ),
            array(
            ...
            array(
                'caption' => 'Монтаж',
                'header' => 'Установка',
                'content' => $product->additional_desc,
            ),
            array(
                'caption' => 'Видео',
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    foreach ($tabs as $tab) {
                        ...
                        echo CHtml::tag('li', $htmlOptions, CHtml::link($tab['caption'], '#tab' . $index, array(
                            'data-toggle' => 'tab',
                        )), true);
                        $index++;
                    }
