...
class OfferController extends Controller
{
    ...
    {
        return array(//'postOnly +processPayment',
        );
    }
    ...
    public function actionIndex()
    {
        ...
        if (isset($_POST[$offerModelClass])) {
            ...
            if ($valid && $offer->validate()) {
                ...
                $offer->offer_text = $this->renderPartial('/offerText', array(
                    'products' => $products,
                ), true);
                $offer->onAfterSave = array(
                    $this,
                    'sendMessage',
                );
                $offer->save();
    ...
    public function sendMessage(CEvent $event)
    {
        Yii::app()->notifier->addNewEvent(
            ...
            $this->renderPartial('/offerMessage', array(
                'model' => $event->sender,
            ), true)
        );
    }
    ...
    */
    ...
    public function actionProcessPayment()
    {
        ...
        $billing = Yii::app()->billing;
        $billing->onSuccess = array(
            $this,
            'onPaymentSuccess',
        );
        $billing->onFail = array(
            $this,
            'onPaymentFail',
        );
        $billing->result();
    ...
    public function actionSuccess()
    {
        ...
        $invoiceId = (int)Yii::app()->request->getParam(Yii::app()->billing->invoiceIdParamName);
        $offer = $this->loadOwnOfferByIdInvoice($invoiceId, array(
            'scopes' => 'done',
        ));
