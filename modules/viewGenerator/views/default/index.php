...
<?php $form = $this->beginWidget('CActiveForm', array(
    ...
    <div class="form-group" style="position: relative;">
        ...
        <label for="CreateViewForm_path"
               style="padding-top: 14px;  position: absolute; font-weight: normal; left: 0; top: 20px;padding-left: 10px;"><?php echo CreateViewForm::VIEWS_PATH; ?></label>
