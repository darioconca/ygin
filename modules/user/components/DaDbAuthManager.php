...
class DaDbAuthManager extends CDbAuthManager
{
    ...
    public function getAuthItemByIdObject($idObject)
    {
        ...
        return $this->getAuthItemByCondition($condition, array(
            ':partName' => '%_object_' . $idObject,
        ));
    }
    ...
    {
        return $this->removeAuthItem($name . '_object_' . $idObject);
    }
     ...
     * @param $idObject
     * @param $idInstance
     * @param bool|true $checkEventWhere
     * @return bool
     */
    ...
    {
        if (isset($this->_userAssignments[$userId])) {
            return $this->_userAssignments[$userId];
        }
