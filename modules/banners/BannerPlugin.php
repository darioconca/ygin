...
class BannerPlugin extends PluginAbstract
{
    ...
    {
        if (isset($config['modules']['ygin.banners'])) {
            return $config['modules']['ygin.banners'];
        }
        return array();
    }
    ...
    public function activate(Plugin $plugin)
    {
        ...
        if ($idsPhpScript) {
            ...
            Yii::app()->db
                ->createCommand()
                ->update('da_site_module', array('is_visible' => DaActiveRecord::IS_VISIBLE), array('in', 'id_php_script', $idsPhpScriptArray));
        }
    ...
    public function deactivate(Plugin $plugin)
    {
        ...
        if ($idsPhpScript) {
            ...
            Yii::app()->db->commandBuilder
                ->createDeleteCommand('da_site_module', $criteria)
                ->execute();
            ...
            Yii::app()->db->commandBuilder
                ->createDeleteCommand('da_php_script', $criteria)
                ->execute();
        }
