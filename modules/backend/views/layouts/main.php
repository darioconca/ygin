...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Russo+One&subset=latin,cyrillic' rel='stylesheet'
          type='text/css'>
    <?php
    /**
...
<div class="navbar navbar-inverse" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#b-navbar-collapse"><span
                    class="sr-only">Меню</span><span class="icon-bar"></span><span class="icon-bar"></span><span
...
<footer class="container">
    <p>© <?= date('Y') ?>, <a href="http://www.ygin.ru" class="ygin-copy">ygin.ru</a></p>
</footer>
<?php
    $this->widget('backend.widgets.objectViewModal.objectViewModalWidget');
?>
</body>
</html>