            ...
            if ($file == null) {
                ...
                if ($fileType == File::FILE_IMAGE) {   //Если свойством являетеся картинка, то пробуем сделать для неё превью.
                    if ($file->getStatusProcess() == 1) {
                        ...
                        $value = "<div class='text-center'><img src='/engine/admin/gfx/msg.png' title='Для данного изображения не может быть сгенирована превью-картинка. Как правило, это связано с ограничением оперативной памяти ({$memory}) на хостинг-площадке.' alt=''></div>";
                    } else {
