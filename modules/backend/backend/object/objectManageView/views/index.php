...
<div id="view-description" style="display:none">
    <div class="form-group">
        ...
        <div class="controls col-lg-8"><input class="form-control" name="create_rep_name" value="<?= $model->getName(); ?>"></div>
    </div>
    <div class="form-group">
        <label class="control-label col-lg-4">Колонки представления</label>

        <div class="controls col-lg-8">
            <?php if (!is_null($idObject) && $model->table_name != "") {
