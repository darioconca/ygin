...
$idObjectStr        = 'null';
$idObjectViewStr    = 'null';

if ( $currentObject = Yii::app()->backend->object){
    $idObjectStr = $currentObject->id_object;
}

if ( $currentObjectView = Yii::app()->backend->objectView){
    $idObjectViewStr = $currentObjectView->id_object_view;
}
